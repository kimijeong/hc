...
4. "④ 해결방안" — 다음 세 가지를 구분해서 구체적으로 제시할 것: (a) 시민 행동요령 — 지금 당장 해야/하지 말아야 할 행동 (예: 접촉·취수 자제, 반려동물 접근 금지 등), (b) 신고 — 부산시 다산콜센터(120) 또는 관할 구청 환경과에 어떤 내용으로 신고하면 좋을지, (c) 당국에 요청할 추가 조사 — 원인을 확정하려면 무엇을 점검해야 하는지 (예: 상류 배출원 점검, 중금속 추가 분석 등). 실측값이 전부 정상 범위면 "특별한 조치가 필요하지 않습니다"라고 명시할 것.
